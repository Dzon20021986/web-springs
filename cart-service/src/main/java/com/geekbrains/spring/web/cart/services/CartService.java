...
public class CartService {
    ...
    public Cart getCurrentCart(String cartName){  // будет возвращать текущую корзину
    ...
    public Cart addProductByIdToCart(Long id, String cartName){  // добавление продукта по id в корзину.
    ...
    @CachePut(value = "Cart", key = "#cartName")
    public Cart clear(String cartName){  // удаление
        Cart cart = getCurrentCart(cartName);
        cart.clear();
        return cart;
    }
    ...
    public void createOrder(String username, OrderDetailsDto orderDetailsDto, String cartName) {
        ...
        order.setTotalCost(currentCart.getTotalCost());
    ...
    @CachePut(value = "Cart", key = "#cartName")
    public Cart removeProduct(Long id, String cartName) { // удаление продукта
        Cart cart = getCurrentCart(cartName);
    ...
    @CachePut(value = "Cart", key = "#cartName")
    public Cart decreaseProduct(Long id, String cartName) {  // уменьшение количества продуктов
        Cart cart = getCurrentCart(cartName);
